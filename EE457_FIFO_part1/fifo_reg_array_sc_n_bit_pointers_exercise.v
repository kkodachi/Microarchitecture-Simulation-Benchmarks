...
assign raw_almost_full  = (depth[ADDR_WIDTH-1:1] == {ADDR_WIDTH-1{1'b1}});
assign raw_almost_empty = (depth[ADDR_WIDTH-1:2] == {ADDR_WIDTH-2{1'b0}} && depth[1] == 1'b1);
...
//task #2: fill in the conditions for signal "empty" and "full".
	if ( (depth == N_zeros) && (AE_AF_flag == 0)  )
		empty = 1'b1;
	if ( (depth == N_zeros) && (AE_AF_flag == 1)  ) 
		full = 1'b1;
end
