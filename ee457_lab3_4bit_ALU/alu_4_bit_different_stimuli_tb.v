...
// test #2 begin
	TEST_ALU ( -3,  -2, 0, 0, 2); // (A,B,AINV,BNEG,Opr)  ADD
// test #2 end

// test #3 begin
	TEST_ALU ( 6,  7, 0, 0, 2); // (A,B,AINV,BNEG,Opr)  ADD
// test #3 end
...
// test #7 begin
	TEST_ALU ( -7,  7, 0, 1, 2); // (A,B,AINV,BNEG,Opr)  SUB
// test #7 end

// test #8 begin
	TEST_ALU ( 6,  -7, 0, 1, 2); // (A,B,AINV,BNEG,Opr)  SUB
// test #8 end
