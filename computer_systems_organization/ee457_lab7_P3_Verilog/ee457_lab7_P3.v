...
assign STALL = (EX1_ADD4 | EX1_ADD1) & ID_XMEX1 & (ID_ADD1 | ID_SUB3) ;
...
assign FORW1 = (EX1_XMEX2 & WB_WRITE) | ((EX2_SUB3 | EX2_MOV) & EX1_XMEX1); // Decide whether to receive any forwarding help or carry EX1_XD
...
assign FORW2 = EX2_XMEX1 & (EX2_ADD4 | EX2_MOV) & WB_WRITE;  // Is it a case of forwarding date from the WB stage
